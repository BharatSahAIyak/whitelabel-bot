...
ARG NEXT_PUBLIC_PWA_DEPLOYER_URL
...
ARG NEXT_PUBLIC_FUSIONAUTH_URL
ARG NEXT_PUBLIC_FUSIONAUTH_KEY
...
ENV NEXT_PUBLIC_FUSIONAUTH_URL=$NEXT_PUBLIC_FUSIONAUTH_URL
ENV NEXT_PUBLIC_FUSIONAUTH_KEY=$NEXT_PUBLIC_FUSIONAUTH_KEY
