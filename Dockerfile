...
ARG NEXT_PUBLIC_INBOUND_API
ARG NEXT_PUBLIC_USER_MANAGEMENT_URL
ARG NEXT_PUBLIC_SEGMENT_ID
...
ENV NEXT_PUBLIC_INBOUND_API=$NEXT_PUBLIC_INBOUND_API
ENV NEXT_PUBLIC_USER_MANAGEMENT_URL=$NEXT_PUBLIC_USER_MANAGEMENT_URL
ENV NEXT_PUBLIC_SEGMENT_ID=$NEXT_PUBLIC_SEGMENT_ID
